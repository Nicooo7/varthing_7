# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2017-03-23 11:59
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('revendication', '0012_evenement_titre'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('personnes', models.ManyToManyField(null=True, through='revendication.Soutien', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='soutien',
            name='competence',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='revendication.Competence'),
        ),
    ]
